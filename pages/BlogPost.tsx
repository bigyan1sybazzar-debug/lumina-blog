...
                      h2: ({ node, ...props }) => (
                        <h2 
                            className="text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-white mt-10 mb-4 border-b border-gray-200 dark:border-gray-700 pb-2" 
                            {...props} 
                        />
                      ),
                      // ✨ FIX APPLIED: Styling for H3 (Main Sections) ✨
                      h3: ({ node, ...props }) => (
                        <h3 
                            className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-3 pt-4 border-t border-gray-200 dark:border-gray-700" 
                            {...props} 
                        />
                      ),
                      // ✨ FIX APPLIED: Styling for H4 (Subsections) ✨
                      h4: ({ node, ...props }) => (
                        <h4 
                            className="text-lg font-semibold text-gray-800 dark:text-gray-300 mt-6 mb-2" 
                            {...props} 
                        />
                      ),
                    }}
...
                  </p>
                </div>
                {/* Placeholder for ReviewSection or Comments, depending on final placement */}
              </div>
