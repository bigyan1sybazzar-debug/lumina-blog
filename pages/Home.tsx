...
  const [heroFeatured, setHeroFeatured] = useState<BlogPost[]>([]);     // ← 3 from Admin (Hero)
  const [editorPicks, setEditorPicks] = useState<BlogPost[]>([]);       // ← Latest 8 for slider
...
      {/* CTA Section (Reduced py- from py-20 to py-16) */}
