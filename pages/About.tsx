...
export const About: React.FC = () => {
  ...
  const skills = [
    { name: "Technical SEO & AEO", level: 97 },
    { name: "WordPress Development", level: 94 },
    { name: "Google Ads & Meta Ads", level: 90 },
    { name: "Full-Stack Web Development", level: 88 },
    { name: "Keyword & Competitor Research", level: 95 },
    { name: "Analytics (GA4, GSC, Looker)", level: 92 },
    { name: "Content Strategy & Optimization", level: 89 },
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        if (entries[0].isIntersecting) {
          setAnimatedSkills(skills.map((_, i) => true));
        }
      },
      { threshold: 0.3 }
    );
              ...
              {skills.map((skill, i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-md">
                  ...
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-primary-500 to-purple-600 rounded-full transition-all duration-2000 ease-out"
                      style={{
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                >
                  ...
                  <button className="ml-4 p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors">
                    {expandedIndex === index ? (
