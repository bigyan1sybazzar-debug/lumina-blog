        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
                {categories.map((cat) => (
                    <button
                        ...
                        className={`px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] transition-all border ${category === cat.id
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20 text-primary-500 gap-4">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">Synchronizing Polls...</span>
                </div>
            ) : polls.length === 0 ? (
